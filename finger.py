...
>>>>>>> 796078eca477dd1a6cc289ae208cbebfd58436a1
def build_filters():
...
def compute(i,img):
	...
	cv2.imwrite("binary"+str(i)+'.png',img)
...
while(1):
	...
	if(ch=="1"):
		'''for i in range(1,4):
			...
			img = cv2.imread('./database/012_3_'+str(i)+'.tif',0)
			#images.append(img)
			x,y=compute(i,img)
			keypoints.append(x)
			descriptors.append(y)'''
		img = cv2.imread('012_3_1.tif',0)
		cv2.imshow("012_3_1.tif",img)
		cv2.waitKey(0)
